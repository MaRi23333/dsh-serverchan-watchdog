...
function WatchdogSettings(props) {
	...
	(0, react.useEffect)(() => {
		...
		refresh();
		timer = window.setInterval(refresh, 1e4);
		return () => {
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						}), keyStatus === "ok" && hasStoredKey && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							onClick: onClearKey,
							style: {
								background: "none",
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						children: t("settings.credential.hint")
					})
				]
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
...
const zh = {
	...
	"settings.sourceHint": "设置保存在本机 $DSH_HOME/serverchan-watchdog/，凭据用 AES-256-GCM（本机密钥）加密存储，永不回显。"
};
const en = {
	...
	"settings.sourceHint": "Settings live in $DSH_HOME/serverchan-watchdog/ on this machine; the credential is encrypted with AES-256-GCM under a per-machine key and is never echoed back."
};
